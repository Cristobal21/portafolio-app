        ...
        <Container>
          ...
          <Navbar.Collapse id="responsive-navbar-nav" className="navs">
            <Col lg={12} className="col-navbar">
              ...
              <Card className="card-lkdin" id="lkdin" onMouseEnter={enterLkdin} onMouseLeave={leaveLkdin}>
                <a href="https://www.linkedin.com/in/crist%C3%B3bal-valderrama-contreras-176275100/" target="_blank" id="link-Lkdin">
                  {!linkedin ? <Card.Img variant="top" id="imgLkdin" src={imgs.lkdin1} /> : <Card.Img variant="top" id="imgLkdin" src={imgs.lkdin2} />}
                </a>
              </Card>
            </Col>
          </Navbar.Collapse>
