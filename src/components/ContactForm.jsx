		...
		<>
			<Form className="form-contact" onSubmit={handleSubmit} id="myForm">
				<Form.Group className="animate__animated animate__zoomIn animate__delay-0.5s animate__duration-1s">
					<FloatingLabel controlId="floatinLabelNombre" label="Tu nombre">
						<Form.Control
							type="text"
							name="nombre"
							size="lg"
				...
				<Form.Group className="animate__animated animate__zoomIn animate__delay-0.5s animate__duration-1s">
					<FloatingLabel controlId="floatinLabelEmail" label="Tu correo">
						<Form.Control
							type="email"
							name="correo"
							size="lg"
				...
				<Form.Group
					controlId="contact.ControlTextarea"
					className="animate__animated animate__zoomIn animate__delay-0.5s animate__duration-1s"
				>
					<FloatingLabel
					...
					{errors.mensaje && (
						<div className="alerta-error">{errors.mensaje}</div>
					)}
				</Form.Group>
				<Button
					type="submit"
					size="lg"
					className="button-submit-contact animate__animated animate__zoomIn animate__delay-0.5s animate__duration-2s"
				>
					Enviar
				</Button>
				{loading && <Loader />}
				{response && (
					<Alert
						...
						className="animate__animated animate__zoomIn animate__delay-0.5s animate__duration-1s"
					>
						<BsCheckCircleFill /> Mensaje enviado exitosamente
					</Alert>
				)}
			</Form>
		</>
